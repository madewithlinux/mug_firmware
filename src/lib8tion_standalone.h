// lib8tion_standalone.h
// based on lib8tion.h from FastLED: https://github.com/focalintent/FastLED-Sparkcore/blob/master/firmware/lib8tion.h

#ifndef __INC_LIB8TION_STANDALONE_H
#define __INC_LIB8TION_STANDALONE_H
